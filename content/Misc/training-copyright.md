...
Most importantly, the facts are contained in the expression in a way that only the human mind can extract and sever from expression, by encoding them in another expression (the learner's own). 
