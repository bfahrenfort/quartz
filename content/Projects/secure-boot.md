...
If you use `grub-btrfs`, you probably had `grub-btrfs-overlayfs` in your hooks. This is incompatible with systemd initramfs. A complete write-up of the issue is in [this GitHub issue](https://github.com/Antynea/grub-btrfs/issues/199), but you can solve it by doing both of the below:
